...
import edu.lmu.cmsi281.assignment4.LinkedNmostRecent;
...
public class LinkedNmostRecentTest {

    LinkedNmostRecent<Integer> list;
    ...
    public void intialize() {
        this.list = new LinkedNmostRecent<Integer>(4);
    }
